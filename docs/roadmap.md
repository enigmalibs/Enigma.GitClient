...
| FEATURE-0DB4 | Bigger icons, readable selected rows  | TODO   | docs/plan/FEATURE-0DB4.md |
| - PHASE01    | One icon scale for the whole app      | TODO   | (in FEATURE-0DB4.md)      |
| - PHASE02    | Readable text on a selected row       | TODO   | (in FEATURE-0DB4.md)      |
...
| FEATURE-B14C | A wider minimap that finds the change | TODO   | docs/plan/FEATURE-B14C.md |
| - PHASE01    | A minimap wide enough to grab         | TODO   | (in FEATURE-B14C.md)      |
| - PHASE02    | Opening at the first change           | TODO   | (in FEATURE-B14C.md)      |
| BUG-876A     | Branch rows: selection and dragging   | TODO   | docs/plan/BUG-876A.md     |
| - PHASE01    | Deselected rows go back to normal     | TODO   | (in BUG-876A.md)          |
