...
| FEATURE-1A7E | Reset the branch to a commit            | TODO   | docs/plan/FEATURE-1A7E.md |
| - PHASE01    | The reset engine                        | TODO   | (in FEATURE-1A7E.md)      |
| - PHASE02    | Soft and hard reset in the line menu    | TODO   | (in FEATURE-1A7E.md)      |
