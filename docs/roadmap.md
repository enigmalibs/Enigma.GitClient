...
| FEATURE-494B | History refs: full names, bigger badges | TODO   | docs/plan/FEATURE-494B.md |
| - PHASE01    | Branch names in full, never trimmed     | TODO   | (in FEATURE-494B.md)      |
| - PHASE02    | A roomier badge, a size bigger          | TODO   | (in FEATURE-494B.md)      |
