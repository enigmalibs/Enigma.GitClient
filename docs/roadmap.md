...
| FEATURE-3030 | History list: columns, menus, search | TODO   | docs/plan/FEATURE-3030.md |
| - PHASE01    | Right-click anywhere on the row      | TODO   | (in FEATURE-3030.md)      |
| - PHASE02    | Real columns with a resizable header | TODO   | (in FEATURE-3030.md)      |
| - PHASE03    | No dragging from the history badges  | TODO   | (in FEATURE-3030.md)      |
...
| - PHASE02    | The minimap replaces the scrollbar   | TODO   | (in FEATURE-5EC4.md)      |
| FEATURE-3B62 | Selectable rows and branch drops     | TODO   | docs/plan/FEATURE-3B62.md |
| - PHASE01    | Selectable branch and tag rows       | TODO   | (in FEATURE-3B62.md)      |
