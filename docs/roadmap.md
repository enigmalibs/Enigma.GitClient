...
| BUG-6CE6     | Details panel ignores the splitter | TODO        | docs/plan/BUG-6CE6.md     |
| FEATURE-0183 | Bigger graph nodes, taller rows    | TODO        | docs/plan/FEATURE-0183.md |
| - PHASE01    | Double the graph node size         | TODO        | (in FEATURE-0183.md)      |
| - PHASE02    | Default row height of 36           | TODO        | (in FEATURE-0183.md)      |
